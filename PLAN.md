...
- [x] Open PR aggregating the session and drive it to a fully green state with reviewer feedback addressed.
...
Evidence: [session-022](./progress/session-022-backup-upload-diagnostics.md), [session-023](./progress/session-023-backup-upload-rca.md), [session-024](./progress/session-024-backup-step-green-fixes.md)
