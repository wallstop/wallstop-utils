...
Describe "Cross-language quality platform conventions" {
    ...
    It "keeps git hooks last-resort with fallback guidance" {
        ...
        $preCommitHook | Should -Match 'resolve_managed_fast_tool "\.tools/native-quality" "actionlint"'
        $preCommitHook | Should -Match 'resolve_managed_fast_tool "\.tools/shell-quality" "shellcheck"'
        $preCommitHook | Should -Match 'fallback_key="windows-x64"'
        $preCommitHook | Should -Match 'for candidate_key in "\$platform_key" "\$fallback_key"'
        $preCommitHook | Should -Match 'extract_precommit_index_blob_for_fast_validation'
        $preCommitHook | Should -Match 'git cat-file -e ":\$\{staged_file\}"'
        $preCommitHook | Should -Match 'git show ":\$\{staged_file\}"'
        $preCommitHook | Should -Match 'E_PRECOMMIT_FAST_BLOB_EXTRACT_FAILED'
        $preCommitHook | Should -Match 'validate_managed_fast_tool_candidate'
        $preCommitHook | Should -Match 'compute_fast_tool_fingerprint'
        $preCommitHook | Should -Match 'executableSha256'
        $preCommitHook | Should -Match 'executableSize'
        $preCommitHook | Should -Match 'executableMtime'
        $preCommitHook | Should -Match 'executableFastFingerprintVersion'
        $preCommitHook | Should -Match 'executableFastFingerprint'
        $preCommitHook | Should -Match 'fast_tool_fingerprint_version'
        $preCommitHook | Should -Match 'read_fast_tool_mtime'
        $preCommitHook | Should -Match 'tail -c "\$length" "\$tool_path"'
        ...
        $preCommitHook | Should -Match '\$\{tool_name\}/\$\{expected_version\}/\$\{candidate_key\}/bin'
        ...
        $prePushHook | Should -Match 'resolve_managed_fast_tool "\.tools/native-quality" "actionlint"'
        $prePushHook | Should -Match 'resolve_managed_fast_tool "\.tools/shell-quality" "shellcheck"'
        $prePushHook | Should -Match 'fallback_key="windows-x64"'
        $prePushHook | Should -Match 'for candidate_key in "\$platform_key" "\$fallback_key"'
        ...
        $prePushHook | Should -Match 'validate_managed_fast_tool_candidate'
        $prePushHook | Should -Match 'compute_fast_tool_fingerprint'
        $prePushHook | Should -Match 'executableSha256'
        $prePushHook | Should -Match 'executableSize'
        $prePushHook | Should -Match 'executableMtime'
        $prePushHook | Should -Match 'executableFastFingerprintVersion'
        $prePushHook | Should -Match 'executableFastFingerprint'
        $prePushHook | Should -Match 'fast_tool_fingerprint_version'
        $prePushHook | Should -Match 'read_fast_tool_mtime'
        $prePushHook | Should -Match 'tail -c "\$length" "\$tool_path"'
        $prePushHook | Should -Not -Match 'run_fast_tool_version_probe'
        $prePushHook | Should -Not -Match '\$tool_path"\s+--?version\s+2>&1\s+\|\|\s+true'
        $prePushHook | Should -Match '\$\{tool_name\}/\$\{expected_version\}/\$\{candidate_key\}/bin'
