<!-- trigger: windows, autohotkey, batch, fast lane, runtime budget | Preserve Windows PR lane validation contracts | Platform | skill-details/windows-language-validation.md -->

# Windows Language Validation

Lightweight skill card for Windows fast-lane and deep-lane quality contracts.

- Expanded guide: [Windows Language Validation (Expanded)](../skill-details/windows-language-validation.md)
