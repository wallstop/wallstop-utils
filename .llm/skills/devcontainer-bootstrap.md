<!-- trigger: devcontainer, bootstrap, toolchain, setup parity | Use devcontainer bootstrap for consistent quality tooling | Platform | skill-details/devcontainer-bootstrap.md -->

# Devcontainer Bootstrap

Lightweight skill card for reproducible environment bootstrap and quality parity.

- Expanded guide: [Devcontainer Bootstrap (Expanded)](../skill-details/devcontainer-bootstrap.md)
